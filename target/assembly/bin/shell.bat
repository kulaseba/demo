...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\\2.4.0.redhat-630187\org.apache.karaf.shell.console-2.4.0.redhat-630187.jar
